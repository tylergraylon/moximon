...
export default function ClaimPrize() {
    ...
    return (
        <div>
            <label className="btn btn-md text-black bg-[#00FFFF] hover:bg-[#FF00FF] rounded-none hidden lg:inline-flex" htmlFor="modal-11">
                CLAIM PRIZE
            </label>
...
const ClaimPrizeBody = () => {
    ...
    const { data, isLoading, mutate } = useSWR<AxiosResponse<{ data: Prizes[] }>>(connected && addr ? `${prizesKey(addr)}` : null, fetcher)
    ...
    const claimPrize = async (prize: Prizes) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                mutate({ data: { data: updatedData } } as AxiosResponse<{ data: Prizes[] }>)
            }
                                                ...
                                                <>
                                                    ...
                                                    <div className={`popover popover-border`}>
                                                        ...
                                                        >
                                                            ...
                                                            {
                                                                prizeLoader && (prizeId === item.id) ? ('PENDING') : ('CLAIM')
                                                            }
                                                        </label>
                                                        <div className={`popover-content my-3 ${showPop} w-[18rem] popover-bottom-left p-2 bg-[#090719] text-white`} tabIndex={0}>
                                                            ...
                                                            <div className="flex flex-col items-center gap-4 py-3">
                                                                ...
                                                                <div className="p-4 text-xs  text-center">
                                                                    You’re about to claim <span className="text-[#FA00FF]">{item.name}</span> on magic wheelz.
                                                                    <br />
                                                                    <br />
