...
export default function Presale() {
  ...
  const {
    ...
    expiryTimestamp: timeToPresale,
    onExpire: () => console.warn("Time for presale!!!"),
  });
  ...
  return (
    <main className="grid lg:grid-cols-2 gap-4 h-full py-10 px-4 sm:px-10">
      <div
        className="bg-[url('/presale-banner.svg')] bg-no-repeat bg-cover 
      ...
      >
        <div className="relative w-full flex  justify-center items-center justify-self-center">
          <h1 className="presale-text-bg text-[13.5vw] md:text-[9vw] lg:text-[8vw] font-extrabold font-serrat">
            {" "}
            Presale
          </h1>
        ...
        {isClient && (
          <div className="xl:text-6xl sm:text-5xl text-3xl flex text-white whitespace-nowrap gap-2">
            ...
            <span>
              {addZero(hours)}
              <div className="md:text-xs text-[0.55rem] text-white/70">
                Hours
              </div>
            </span>
            :
            ...
            <span>
              {addZero(seconds)}
              <div className="md:text-xs text-[0.5rem] text-white/70">
                Seconds
              </div>
            </span>
          </div>
