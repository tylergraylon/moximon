                ...
                <div className="navbar-end">
                    ...
                    <div className="hidden lg:flex">
                        ...
                        <Link
                            ...
                            className="flex justify-center items-center navbar-item"
                        >
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#FF00FF] fill-white">
